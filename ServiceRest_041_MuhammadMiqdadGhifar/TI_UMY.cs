...
namespace ServiceRest_041_MuhammadMiqdadGhifar
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-NEBDS2U0;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-NEBDS2U0;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
